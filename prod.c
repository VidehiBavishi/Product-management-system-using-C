    ...
    do
{
    ...
    printf("\n  ____________________  LOGIN   ____________________ ");
    printf("\n                                                     ");
    printf(" \n                        USERNAME:-");
	scanf("%s", &uname);
	printf(" \n                        PASSWORD:-");
	...
	i=0;
	//scanf("%s",&pword);
		if(strcmp(uname,"videhi")==0 && strcmp(pword,"vid")==0)
	{
...
void menu(void)
{
	...
	system("cls");
	main:
	printf("\n______________________________ Product Management System _________________________________");
	printf("                                                                                          ");
	printf("                                                                                          ");
